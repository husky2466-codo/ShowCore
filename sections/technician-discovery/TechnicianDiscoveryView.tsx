import data from '@/../product/sections/technician-discovery/data.json'
import { TechnicianDiscovery } from './components/TechnicianDiscovery'
import type { Technician, Filters, SearchState } from '@/../product/sections/technician-discovery/types'
